...
class NewsSinaSpider(CrawlSpider):
    name = 'news.sina'
    allowed_domains = ['news.sina.com.cn']
    start_urls = ['http://news.sina.com.cn']
    nbf = NewsBloomFilter('news_sina')
    ...
    rules = [# 规则1匹配文本页面，一定做URL去重
             ...
             # 规则2匹配新闻索引页面，不提取文本。
             Rule(LinkExtractor(allow=(r'http://news.sina.com.cn/.*?/')), process_links=nbf.filter_index)]
    ...
    def parse_item(self, response):
        ...
        if h1:
            ...
            loader.add_xpath('title', '//th[contains(@class, "f24")]/text()')
